...
curl -X POST http://10.99.201.177:8040/api/update_config?streaming_load_json_max_mb=1073741824\&persist=true
curl -X POST http://10.99.197.74:8040/api/update_config?streaming_load_json_max_mb=1073741824\&persist=true
curl -X POST http://10.99.194.79:8040/api/update_config?streaming_load_json_max_mb=1073741824\&persist=true
curl -X POST http://10.99.200.146:8040/api/update_config?streaming_load_json_max_mb=1073741824\&persist=true
curl -X POST http://10.99.204.175:8040/api/update_config?streaming_load_json_max_mb=1073741824\&persist=true
