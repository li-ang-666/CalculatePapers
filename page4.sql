...
CREATE TABLE `prism_shareholder_path`.`ratio_path_company_new` (
  ...
  `investment_ratio_direct` decimal(24,12) NOT NULL DEFAULT '0' COMMENT '直接持股比例',
  `max_deliver` decimal(24,12) NOT NULL DEFAULT '0' COMMENT '最大直接持股传递',
  `investment_ratio_total` decimal(24,12) NOT NULL DEFAULT '0' COMMENT '总持股比例',
